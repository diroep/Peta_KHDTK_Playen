...
map.getView().fit([12299910.054294, -892243.142998, 12304407.691489, -890033.188280], map.getSize());
...
var Title = new ol.control.Control({
    element: (() => {
        ...
        titleElement.innerHTML = '<h2 class="project-title">Peta KHDTK Playen</h2>';
        return titleElement;
    })(),
    ...
    element: (() => {
        ...
        if (39 > 240) {
            ...
            window.showAbstract = function() {
                ...
                linkElement.innerHTML = 'Klik nama KHDTK untuk melihat informasi';
            }
